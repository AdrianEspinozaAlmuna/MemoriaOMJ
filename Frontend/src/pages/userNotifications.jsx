          ...
          <div className="grid gap-3.5">
            {visibleNotifications.map(item => (
              <div
                ...
                className={`relative grid cursor-pointer gap-4 rounded-[14px] border px-4 py-4 text-left shadow-[0_4px_8px_-4px_rgba(16,24,40,0.12)] lg:grid-cols-[auto_1fr_auto] lg:items-start transition-colors ${!item.read ? "border-[#b8dcc8] bg-[#f0faf5] hover:bg-[#e8f5ee]" : "border-[#d8e6dd] bg-white"}`}
              >
