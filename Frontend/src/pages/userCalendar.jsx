...
export default function UserCalendar() {
  ...
  return (
    <section className="max-w-7xl mx-auto px-4 py-6 space-y-8">
      ...
      <section className="rounded-xl border border-[#d8e6dd] bg-[var(--panel-bg)] p-6 shadow-sm space-y-4">
        <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-4">
          <label className="grid gap-2 text-[0.82rem] font-semibold text-[var(--text)]">
            ...
            <select className="rounded-lg border border-[#d8e6dd] bg-[var(--panel-bg)] px-3 py-2 text-[0.9rem] text-[var(--text)] outline-none focus:border-[var(--primary)] focus:ring-2 focus:ring-[#05a63d]/20" value={selectedCategory} onChange={event => setSelectedCategory(event.target.value)}>
          ...
          <label className="grid gap-2 text-[0.82rem] font-semibold text-[var(--text)]">
            ...
            <input className="rounded-lg border border-[#d8e6dd] bg-[var(--panel-bg)] px-3 py-2 text-[0.9rem] text-[var(--text)] outline-none focus:border-[var(--primary)] focus:ring-2 focus:ring-[#05a63d]/20" type="date" value={selectedDate} onChange={event => setSelectedDate(event.target.value)} />
          </label>
          ...
          <label className="grid gap-2 text-[0.82rem] font-semibold text-[var(--text)]">
            ...
            <select className="rounded-lg border border-[#d8e6dd] bg-[var(--panel-bg)] px-3 py-2 text-[0.9rem] text-[var(--text)] outline-none focus:border-[var(--primary)] focus:ring-2 focus:ring-[#05a63d]/20" value={selectedStatus} onChange={event => setSelectedStatus(event.target.value)}>
          ...
          <label className="grid gap-2 text-[0.82rem] font-semibold text-[var(--text)]">
            ...
            <select className="rounded-lg border border-[#d8e6dd] bg-[var(--panel-bg)] px-3 py-2 text-[0.9rem] text-[var(--text)] outline-none focus:border-[var(--primary)] focus:ring-2 focus:ring-[#05a63d]/20" value={viewMode} onChange={event => setViewMode(event.target.value)}>
